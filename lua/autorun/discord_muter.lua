...
CreateConVar(globals.con_vars.DISCORD_NAME, "Discord", {FCVAR_ARCHIVE, FCVAR_NOTIFY}, "Sets the Plugin Prefix for helpermessages.") --The name which will be displayed in front of any Message
